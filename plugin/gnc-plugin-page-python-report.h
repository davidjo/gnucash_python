...
#ifndef __GNC_PLUGIN_PAGE_PYTHON_REPORT_H
#define __GNC_PLUGIN_PAGE_PYTHON_REPORT_H
...
/* type macros */
#define GNC_TYPE_PLUGIN_PAGE_PYTHON_REPORT            (gnc_plugin_page_python_report_get_type ())
#define GNC_PLUGIN_PAGE_PYTHON_REPORT(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), GNC_TYPE_PLUGIN_PAGE_PYTHON_REPORT, GncPluginPagewindowPythonReport))
 ...
 **/
GType gnc_plugin_page_python_report_get_type( void );

/**
 * @param reportId The scheme-defined report identifier
 * @return a new "report" plugin page.
 */
GncPluginPage *gnc_plugin_page_python_report_new( int reportId );
