 ...
 * return : (transfer none): plugin name
 *
 ...
 * @action_group : The group of all actions associated with a
    ...
    group.
 * @toolbar_labels : (array zero-terminated=1) : A pointer to a NULL terminated array of data
 ...
 *  group.
 *
 *  @param names A list of actions names to be marked important.  This
 *  list must be NULL terminated.
 */
