...
/**
 * qof_book_new:
 * Returns: (transfer full): A #QofBook
 */
 ...
 * qof_book_get_slots:
 * @book : A #QofBook
 * return : (transfer none) : A #KvpFrame
 *
 ...
 * @book : A #QofBook
 * return : (transfer full) : date pointer
 *
