...
// QofId defines this function but QofInstance contains a QofId - circular references
// QofInstance * qof_collection_lookup_entity (const QofCollection *col, const GncGUID *guid);
// Im having serious issues I think with circular references leading to crashing
// g-ir-compiler runs
