...
// in C this gets re-typed here as the parent type
// I dont think we do this for python - this will be a subclass of GncHtml
/**
 * gnc_html_webkit_new:
 * returns: (transfer full): A #GncHtmlWebkit
 */
GncHtmlWebkit* gnc_html_webkit_new( void );
