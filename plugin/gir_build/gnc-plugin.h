...
// why both these included - gnc-main-window.h includes gnc-plugin-page.h on its own
//#include "gnc-main-window.h"
#include "gnc-main-window-bootstrap.h"
// I cannot see why this is included - what is needed from it??
...
/**
 * GncPluginClass:
 * @important_actions: (array zero-terminated=1) : A NULL terminated list of actions names
    should modified.
 */
...
typedef struct
{
    ...
    /**
     * add_to_window:
     * @user_data:  A pointer to the this GncPlugin data
        structure.
     * @window:  A pointer to the window in which this plugin
        has just been installed.
     * @type:  An identifier for the type of window
        specified.  Currently the only type is a "main" content window.
     */
    /*
     *
     ...
     * @user_data: A pointer to the this GncPlugin data
        structure.
     * @window: A pointer to the window from which this
...
/**
 * gnc_plugin_get_name:
 * return: (transfer none): A string containing the name of this plugin
 *
 ...
 * @action_group: The group of all actions associated with a
    plugin or plugin page.  All actions to me modified must be in this
    group.
 * @toolbar_labels: (array zero-terminated=1) (element-type action_toolbar_labels) : A pointer to a NULL terminated array of data
 ...
 * @action_group: The group of all actions associated with a
    plugin or plugin page.  All actions to me modified must be in this
    group.
 * @names: (array zero-terminated=1) : A list of actions names to be marked important.  This
 ...
 * @action_group: The group of all actions associated with a
    plugin or plugin page.  All actions to me modified must be in this
    group.
 * @action_names: (array zero-terminated=1) : A NULL terminated list of actions names that
    should modified.
 * @property_name: The property name to be changed on the
    specified actions. The only two GtkAction properties that it makes
    sense to modify are "visible" and "sensitive".
 *  @value: A boolean specifying the new state for the specified
    property.
 *
 ...
 * @ui_merge: A pointer to the UI manager data structure for a
    window.
 * @action_group: The set of actions provided by a given plugin.
 * @filename: The name of the ui description file.  This file
