 ...
 *  @page: The new page of data to be displayed, or the existing
 ...
 *  @fn : (scope call) : A pointer to the function to be called.
 ...
 *  @window: A pointer to the window whose front page should be
 *  returned.
 * Returns: (transfer none): A pointer to the GncPluginPage currently at the front of
 ...
 *  @window: A pointer to the window whose uimanager should be
 *  returned.
 * Returns: (transfer none): A pointer to the GtkUIManager which is used for the menu
 * item merging
 *
 ...
 *  @window: A pointer to the window whose user interface should
 *  be updated.
 *  @group_name: The name for this set of actions.  This name
 *  should be unique among all groups added to the window, and will be
 *  needed to remove the actions from this window.
 *  @group: A pointer to an array of GtkActions.  These are the
 *  actions that will be added to the user interface.
 *  @merge_id: A merge identifier retrieved from a call to
 ...
 *  should be unique among all groups added to the window, and will be
 *  needed to remove the actions from this window.
 *  @entries: A pointer to an array of GtkActionEntry.  These
 *  are the actions that will be added to the user interface.
 *  @n_entries: The number of actions in the array.
 *  @toggle_entries: A pointer to an array of GtkToggleActionEntry.
 ...
 *  @filename: The filename containing the user interface
 *  definition that goes with this set of actions.
 *  @user_data: The data to be provided to all callback
 *  functions.
 *
 ...
 *  @window: A pointer to the window whose user interface should
 *  be updated.
 *  @group_name: The name for this set of actions.  This must be
 ...
 *  @group_name: The name of a set of actions.  This must be a
 *  name provided when the actions were installed.
 * Returns: (transfer none): A pointer to a GtkActionGroup that was added with the
 ...
 *  @whatever: Whatever widget had focus when the user issued the
 *  keyboard context-menu request.
 *  @event: The event parameter describing where on the screen
 *  the mouse was pointing when clicked, type of click, modifiers,
 *  etc.
 *  @page: This is the GncPluginPage corresponding to the visible
 *  page.
 *
 ...
 *  @window: The window to restore state for
 *
 ...
 *  @sensitive: Whether or not the user should be able to invoke
 *  this action.
 *
 ...
 * Returns: (transfer none): A pointer to a GtkAction that was added with the
 *  specified name. If the name cannot be found, then NULL will be
 *  returned
 *
 ...
 *
 * Returns: (transfer none): A pointer to the GtkWidget for the dialog that can be used
