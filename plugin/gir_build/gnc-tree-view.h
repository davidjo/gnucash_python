...
// currently Ive decided the column adding functions should be transfer none
// - the column is added to the underlying tree view in addition to being
// returned - so think its only freed on tree view free or specific removal
 ...
 * @column_sort_fn: (scope call)
 * @toggle_edited_cb: (scope call)
 ...
 * @column:
 * returns: (transfer none) : GtkCellRenderer
 *
