...
*/
// DISABLE THESE FOR INTROSPECTION!!
...
/**
 * kvp_frame_new:
 * Returns: (transfer none): A pointer to the new frame
 *
...
/**
 * kvp_frame_copy:
 *  @frame: A pointer to the existing frame
 *
 * Returns: (transfer none): A pointer to the new frame copy
 *
 ...
 * return : (transfer none) : It returns the old value, if any.
 *
...
/**
 * kvp_frame_get_frame:
 * return : (transfer none) : The KvpFrame at the specified path, or NULL if it doesn't exist
 */
/*@ dependent @*/
KvpFrame  * kvp_frame_get_frame(const KvpFrame *frame, const gchar *path);
/**
 * kvp_frame_get_frame_slash:
 * return : (transfer none) : The KvpFrame at the specified path, or NULL if it doesn't exist
 */
 ...
 * @frame:
 * @value:
 * @key_path: (element-type guint64) : cannot use gpointer here - and * seem to be ignored??
 *
...
/**
 * kvp_frame_get_slot: 
 * return : (transfer none) : Returns the KvpValue in the given KvpFrame 'frame' that is
  associated with 'key'.
 *
...
/**
 * kvp_glist_compare:
 * @list1: (element-type guint64) : cannot use gpointer here - and * seem to be ignored??
 * @list2: (element-type guint64) : cannot use gpointer here - and * seem to be ignored??
 *
...
/**
 * kvp_glist_copy:
 * @list : (element-type guint64) : cannot use gpointer here - and * seem to be ignored??
 * return : (element-type guint64) (transfer none) : cannot use gpointer here - and * seem to be ignored??
 *
...
/**
 * kvp_value_new_glist:
 * @value : (element-type guint64) : cannot use gpointer here - and * seem to be ignored??
 * return : (transfer none) : 
 *
 ...
 * @lst : (element-type guint64) : cannot use gpointer here - and * seem to be ignored??
 * return : (transfer none) : 
 *
 * Creates a KvpValue from a <b>GList of kvp_value's</b>! (Not to be
 * confused with GList's of something else!)
 ...
 * @newlist : (element-type guint64) : cannot use gpointer here - and * seem to be ignored??
 * return : (element-type guint64) (transfer none) : cannot use gpointer here - and * seem to be ignored??
 *
