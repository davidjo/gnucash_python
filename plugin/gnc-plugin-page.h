...
typedef struct
{
     ...
     *
     * return : (transfer full) : A displayable gtk widget.
     */
     ...
     * @file : A pointer to the GKeyFile data structure where the page information should be written.
     * @group : The group name to use when writing data.  The name is specific to this page instance.
     *
     *  Save enough information about this page so that it can be
     *  recreated next time the user starts gnucash.
     */
    void (* save_page) (GncPluginPage *page, GKeyFile *key_file,
                        const gchar *group_name);

    /** 
     * recreate_page:
     * @window : The window where this new page will be installed.
     * @file : A pointer to the GKeyFile data structure where the page information should be retrieved.
     * @group : The group name to use when retrieving data.  The name is specific to this page instance.
     *
     ...
     *
     * return : (transfer full) : A pointer to the new page.
     */
    ...
    /**
     * window_changed:
     * @plugin_page : The page that was added to a window.
    ...
    /**
     * page_name_changed:
     * @plugin_page : The page to update.
     ...
     * @plugin_page : The front page in a main window..
    ...
    /**
     * finish_pending:
     * @plugin_page : The page in a main window.
     *
     ...
     *
     * return : FALSE if the page could not or would not comply, which should cancel the pending operation.  TRUE otherwise
     */
 ...
 *
 * return : (transfer full) : A #GncPluginPage recreated page
 */
 ...
 *
 * return : (transfer none) : The name of this plugin.  This string is owned by the plugin.
 */
 ...
 *
 * return : TRUE if the page refers to the specified book. FALSE otherwise.
 */
 ...
 *  this page.
 *
 * return : (transfer none) : A pointer to the window.
 */
 ...
 *
 * return : (transfer none) : The page's name.  This string is owned by the page and should not be freed by the caller.
 */
 ...
 *  in the notebook tab.
 *
 * return : (transfer none) : The color for this page.  This string is owned by the page and should not be freed by the caller.
 */
 ...
 *
 * return : (transfer none) : The URI for this page.  This string is owned by the page and should not be freed by the caller.
 */
 ...
 *
 * return : (transfer none) : A pointer to the statusbar text for this page.  This string is owned by the page and should not be freed by the caller.
 */
 ...
 *
 * return : (transfer none) : A pointer to the filename used for the UI.  This string is owned by the page and should not be freed by the caller.
 */
 ...
 *
 * return : (transfer none) : A pointer to the GtkUIManager object for this page.
 */
 ...
 *
 * return : (transfer none) : A pointer to the GtkActionGroup object for this page.
 */
 ...
 *
 * return : (transfer none) : A pointer to the newly created GtkActionGroup object for this page.
 */
 ...
 *
 * return : (transfer none) : A pointer to the retuested GtkAction object or NULL.
 */
