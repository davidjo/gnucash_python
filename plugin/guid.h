 ...
 *  guid_init() will be called before the id is created.
 *
 * return : (transfer full) : A data structure containing a newly allocated GncGUID.
 ...
 * guid_copy:
 * @guid: A #GncGUID
 * Return: (transfer full) : A #GncGUID
 */
GncGUID *guid_copy (const GncGUID *guid);

/**
 * guid_to_string:
 * @guid: A #GncGUID. The guid to print
 ...
 *
 * return : (transfer none) : A pointer to the starting character of the string.  The
 ...
 * guid_to_string_buff:
 * @guid: A #GncGUID
 * @buff: (out) : The buffer to print it into.
 ...
 *
 * return: (transfer none) : A pointer to the terminating null character of the string.
 */
...
/**
 * guid_hash_table_new:
 * Returns : (transfer full) : a GHashTable with <GUID*> as key and a <gpointer> as
