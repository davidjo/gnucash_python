...
/**
 * gnc_main_window_new:
 * return : (transfer full) : A pointer to the new object.
 *
 ...
 * @window : A pointer to the window whose front page should be
    returned.
 * return : (transfer none) : A pointer to the GncPluginPage currently at the front of
 ...
 * return : (transfer none) : A #GtkUIManager
 *
