...
#include "qofinstance_bootstrap.h"
 ...
 * qof_collection_new:
 * @type: A QofIdType
 * Returns: (transfer full): A #QofCollection
 */
 ...
 * @col: A #QofCollection pointer
 *  return the type that the collection stores
 * Returns: (transfer none) : a #QofIdType (actually a string)
 */
 ...
 * @col: A #QofCollection pointer
 * @guid: A #GncGUID pointer
 *  Find the entity going only from its guid
 * Returns: (transfer none): A #QofInstance pointer
 */
/*@ dependent @*/
QofInstance * qof_collection_lookup_entity (const QofCollection *col, const GncGUID *guid);

/*  Callback type for qof_collection_foreach */
typedef void (*QofInstanceForeachCB) (QofInstance *ent, gpointer user_data);

/**
 * qof_collection_foreach:
 * @col: A #QofCollection
 * @cb_func: (scope call) : A callback
 * @user_data: A #gpointer
 *
 *  Call the callback for each entity in the collection.
 */
void qof_collection_foreach (const QofCollection *col, QofInstanceForeachCB cb_func,
                             gpointer user_data);
 ...
 *
 * Returns: (transfer none): A #gpointer to the data
 */
 ...
 * @type:
 * @glist: (element-type GObject)
 *
 *  again - not clear what the element-type should be
 *  why does gpointer not work
 *
...
@return NULL if any of the entities fail to match the
	...
	on success.
 *
 * returns: (transfer none): A #QofCollection
*/
QofCollection*
