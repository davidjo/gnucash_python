 ...
 * @column_title : The full title for this column.  This will be
    added as a tooltip what will be displayed when the mouse is
    hovered over the column title button.
 * @column_short_title : This is what will actually be displayed
 ...
 * @pref_name : The internal name of this column.  This name is
    used in several functions to look up the column, and it is also
    used when saving/restoring the view's state.
 * @model_data_column : The index of the GtkTreeModel data column
 ...
 * @model_visibility_column : The index of the GtkTreeModel data
 ...
 * @column_sort_fn : (scope notified) : The function that GtkTreeModelSort
    will call to compare two rows to determine their displayed order.
 * @toggle_edited_cb : (scope notified) : The function to call when the user toggles
    the state of a checkbox.
 * return : (transfer full): The newly created GtkTreeViewColumn.
 *
 ...
 * @combo_tree_model :
 * @combo_model_text_column :
 * @column_sort_fn : (scope notified)
 * return : (transfer full) : The newly created GtkTreeViewColumn.
 *
 ...
 * @model_color_column : The index of the GtkTreeModel data
 ...
 * return : (transfer none) : The current state section.
 *
 ...
 * @view : The tree view.
 * @section : Link the view to this saved state section.
 ...
 * @first_column_name : 
 *
 * this cannot be introspected as has variable arguments
 *
 ...
 * @func : (scope notified) : This is a cell data function that sets the "cell-background".
 *
 ...
 * returns : (transfer none) : The cell renderer in use in the column.
 *
