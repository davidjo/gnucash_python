 ...
 * return : (transfer full) : A pointer to a new account tree view.
 * 
 ...
 * @source_cb : (scope notified) : A callback function that is expected to provide
    the data to be displayed.
 * @edited_cb : (scope notified) : A callback function that will be called if the
    user edits the displayed data.
 * return : (transfer full) : the new column
 *
 ...
 * @view : A pointer to an account tree view.
 * @column_title : The title for this new column.
 * @kvp_key : The lookup key to use for looking up data in the
 ...
 * @account: account The account to be tested.
 ...
 * @account_view : A pointer to an account tree view.
 * @func : (scope notified) : A filtration function that is called on individual
 ...
 * @destroy : (scope notified) : A function to destroy the data block.  This
 ...
 * return : (transfer none): The account associated with this path.
 *
 ...
 * return : (transfer none) : The account associated with this iter.
 *
 *  This function returns the account associated with the specified
 ...
 * @view : A pointer to an account tree view.
 * return : (transfer none) : The account at the cursor.
 *
 ...
 * @view : A pointer to an account tree view.
 * return : (transfer none) : The selected account, or NULL if no account was selected.
 *
 ...
 * @view : A pointer to an account tree view.
 * return : (element-type Account*) (transfer container) : A list of accounts, or NULL if no account was selected.
 *
 ...
 * @view : A pointer to an account tree view.
 * @account_list : (array zero-terminated=1) (element-type Account*) : A list of accounts to select.
 * @show_last : Force the window to scroll to the last account
    selected.
 *
 ...
 * @view : A pointer to an account tree view.
 * @account : A pointer to the account whose children should be
    selected.
 *
